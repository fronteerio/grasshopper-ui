...
define(['exports'], function(exports) {
    ...
    var templates = exports.templates = {
        ...
        'admin-app': '/shared/gh/partials/tenant-admin/tenant-admin-app.html',
        'admin-app-config': '/shared/gh/partials/tenant-admin/tenant-admin-config.html',
        'admin-app-navigation': '/shared/gh/partials/tenant-admin/tenant-admin-navigation.html',
        'admin-app-user': '/shared/gh/partials/tenant-admin/tenant-admin-app-user.html',
        'admin-app-user-search': '/shared/gh/partials/tenant-admin/tenant-admin-app-user-search.html',
        ...
        'admin-borrow-series-modal': '/shared/gh/partials/tenant-admin/borrow-series-modal.html',
        'admin-borrow-series-module-item': '/shared/gh/partials/tenant-admin/borrow-series-module-item.html',
        'admin-delete-module-modal': '/shared/gh/partials/tenant-admin/delete-module-modal.html',
        'admin-delete-module-overview': '/shared/gh/partials/tenant-admin/delete-module-overview.html',
        'admin-delete-series-modal': '/shared/gh/partials/tenant-admin/delete-series-modal.html',
        ...
        'admin-editable-parts': '/shared/gh/partials/tenant-admin/editable-parts.html',
        ...
        'admin-new-module-modal': '/shared/gh/partials/tenant-admin/new-module-modal.html',
        'admin-new-series': '/shared/gh/partials/tenant-admin/new-series.html',
        'admin-rename-module-modal': '/shared/gh/partials/tenant-admin/rename-module-modal.html',
        ...
        'admin-visibility-button': '/shared/gh/partials/tenant-admin/visibility-button.html',
        'admin-visibility-modal': '/shared/gh/partials/tenant-admin/visibility-modal.html',
